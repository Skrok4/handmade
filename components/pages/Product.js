    ...
    this.element.innerHTML = `
         ...
         <div class="product__info">
            <div class="product__info--top">
               ...
               <div class="product__count">В наявності: ${item.rating.count}</div>                
               <div class="product__description">${item.description}</div>
            </div>
            <div class="product__info--bottom">
               <div class="product__price"><span>Тільки сьогодні</span>  ${item.price}₴</div>
               <a class='item__btn--save'>Додати в кошик</a>
            </div>
         </div>
      `;
  }
